...
public class FilaController {
	...
	public void chamarParaConsultas(Fila fila, Fila filaPrioritarios) throws Exception {
		try {
			if (((chamadasPrioritarias > 0 && chamadasPrioritarias % 3 == 0) || filaPrioritarios.isEmpty() && 
					!fila.isEmpty())) {
				chamar(fila);
	...
	private void chamarPrioritarios(Fila filaPrioritarios) throws Exception {
	...
	private void chamar(Fila fila) throws Exception {
		chamadasPrioritarias = 0;
